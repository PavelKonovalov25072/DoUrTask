...
const SvgCheckmark = ({className}) => {
    return (
        <div className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="56px" height="46px" viewBox="0 0 122.877 101.052" enableBackground="new 0 0 122.877 101.052" space="preserve">
                <g>
